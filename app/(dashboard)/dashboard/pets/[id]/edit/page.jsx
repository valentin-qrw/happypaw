...
export default function EditPetPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!currentUser || !pet) {
            toast.error("Не всі обов’язкові поля заповнені");                
            return;
        }

        // Check if the user owns this pet
        if (pet.ownerId !== currentUser._id) {
            toast.error("Ви можете редагувати лише власних тварин");
            return;
        }
        ...
        try {
            ...
            console.error("Не вдалося оновити інформацію", error);
            toast.error("Не вдалося оновити інформацію про тварину. Повторіть спробу");
        } finally {
    ...
    const handleDelete = async () => {
        ...
        if (pet.ownerId !== currentUser._id) {
            toast.error("Ви можете видаляти лише власних тварин");
            return;
        };

        if (!confirm("Ви впевнені, що хочете видалити цю тварину? Цю дію неможливо скасувати.")) {
            return;
        };
        ...
        try {
            ...
            console.error("Не вдалося видалити тварину", error);
            toast.error("Не вдалося видалити тварину.")
        }
    }
            ...
            <div className="flex min-h-screen items-center justify-center">
                <Card className="max-w-md">
                    <CardContent className="p-8 text-center">
                        ...
                        <p className="mb-4">
                            Ви можете редагувати лише власних тварин
                        </p>
            ...
            <div className="mb-8">
                ...
                <div className="text-center">
                    ...
                    <h1 className="mb-2 text-3xl font-bold text-gray-900">
                        Редагувати профіль тварини
                    </h1>
                    <p>Оновіть інформацію про тварину</p>
                </div>
            </div>
